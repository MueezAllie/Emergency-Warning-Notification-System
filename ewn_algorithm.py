...
#             print('------------------------------------------------------------------------------------------------------------------')
            ...
            esTime = datetime.now()
            esTimeTaken = esTime - startTime
#             print('\nTime taken for the Fire Department to be notified = ', esTimeTaken, 'seconds')
...
#             print('------------------------------------------------------------------------------------------------------------------')
            ...
            esTime = datetime.now()
            esTimeTaken = esTime - startTime
#             print('\nTime taken for the Emergency Services to be notified = ', esTimeTaken, 'seconds')
...
#             print('\n------------------------------------------------------------------------------------------------------------------')
#             print('Notifying Police Department')
#             print('------------------------------------------------------------------------------------------------------------------')
            policeDepartment = alert_police(myData, timestamp)
            
            esTime = datetime.now()
            esTimeTaken = esTime - startTime
#             print('\nTime taken for the Police Department to be notified = ', esTimeTaken, 'seconds')
...
#             print('------------------------------------------------------------------------------------------------------------------')
            ...
            esTime = datetime.now()
            esTimeTaken = esTime - startTime
#             print('\nTime taken for the EMS to be notified = ', esTimeTaken, 'seconds')
...
#             print('------------------------------------------------------------------------------------------------------------------')
    ...
    print('\nTime taken for the process to complete = ', timeTaken, 'seconds')
    print('\nend')
    print('------------------------------------------------------------------------------------------------------------------')
...
client.username_pw_set("server","raspberry")
